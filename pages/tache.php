                  ...
                  <form method="get" action="voir_plus.php" >
                    <div class="task-content">
                      ...
                      <div class="end-task-content">
                        ...
                        <input type="hidden" name="idTache" value="'.$row['idTache'].'">
          ...
          <?php 
            ...
            foreach($arrays as $key => $array){    
              // foreach($value as $key2 => $line){
                  ...
                  echo '           
                    <option selected value="'.$array['prioriteId'].'">'.$array['prioriteType'].'</option>       
                  ';
              // }
            }
            echo '</select>';
            ...
            foreach ($arrays2 as $key2 => $array2) {
                echo '           
                <option selected value="'.$array2['statuId'].'">'.$array2['statuType'].'</option>       
              ';
            }
            echo '</select>';
          ?>
